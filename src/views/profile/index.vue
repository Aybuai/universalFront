<template>
  ...
  >
    <div
      class="relative max-w-[1024px] mx-auto bg-white dark:bg-zinc-900 duration-400 xl:rounded-sm xl:border-zinc-200 xl:dark:border-zinc-600 xl:border-[1px] xl:px-4 xl:py-2"
    >
      <!-- 移动端 navbar -->
      ...
      <div class="h-full w-full px-1 pb-4 text-sm mt-2 xl:w-2/3 xl:pb-0">
        ...
        <m-button
          ...
          class="w-full dark:text-zinc-300 dark:bg-zinc-800"
          @click="onLogoutClick"
        >
          退出登录
        </m-button>
