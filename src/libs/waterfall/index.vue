<template>
  ...
  >
    ...
    <!-- 可以给一个加载中的描述，没有也无所谓 -->
    <!-- <div v-else class="flex justify-center items-center">加载中...</div> -->
  </div>
</template>
...
/**
 * 1. containerHeight：总高度
 * 2. columnWidth：列宽
 * 3. item._style.left：每个 item 对应的 left
 * 4. item._style.right：每个 item 对应的 right
 */
